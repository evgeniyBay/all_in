...
function renderGame() {
    ...
    for (i=0; i<playerHand.length; i++) { //This loop loads and prints out the card values from the array as well as loading the card images
        ...
        let srcId = "pcard"+i
        document.getElementById(srcId).src = "img/" + playerHand[i] + ".png"
    }
    ...
    if (isDealerTurn === true) { //Only render all cards if it's the dealer turn. Otherwise only display first card
        for (i=0; i<dealerHand.length; i++) {
            ...
            let srcId = "dcard"+i
            document.getElementById(srcId).src = "img/" + dealerHand[i] + ".png"
        }
        ...
        document.getElementById("dcard0").src = "img/" + dealerHand[0] + ".png"
        document.getElementById("dcard1").src = "img/green_back.png"
        cardBlanks = 6
